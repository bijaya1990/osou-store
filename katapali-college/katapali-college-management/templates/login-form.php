...
$tagline = get_theme_mod( 'kc_tagline', '' );
...
<style>
	...
	#kcms-login-page{--kp:<?php echo esc_html( $primary ); ?>;--kd:<?php echo esc_html( $dark ); ?>;--ka:<?php echo esc_html( $accent ); ?>;--kg:<?php echo esc_html( $gold ); ?>;
		...
		margin:-1px 0 0;padding:56px 16px;display:flex;justify-content:center;
		font-family:'Inter',system-ui,-apple-system,sans-serif;position:relative;overflow:hidden;
	}
...
<div id="kcms-login-page">
	<div class="kcms-lp-card">
		...
		<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="kcms-lp-form">
			...
			<p class="kcms-lp-sub" id="kcms-login-sub">Enter the Mobile Number and Date of Birth on your <?php echo 'teacher' === $requested_type ? 'Teacher/Staff' : 'Student'; ?> record.</p>

			<div class="kcms-lp-field">
				<label for="kcms-lp-mobile"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="7" y="2" width="10" height="20" rx="2"/><line x1="11" y1="18" x2="13" y2="18"/></svg> Mobile Number</label>
				<input id="kcms-lp-mobile" type="tel" name="mobile" inputmode="numeric" pattern="[0-9+ ]{8,15}" placeholder="98765 43210" required autofocus>
			</div>
			<div class="kcms-lp-field">
				<label for="kcms-lp-dob"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg> Date of Birth</label>
				<input id="kcms-lp-dob" type="date" name="dob" required>
			</div>
