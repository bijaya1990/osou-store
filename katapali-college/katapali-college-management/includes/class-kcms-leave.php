...
class KCMS_Leave {
	...
	public static function shortcode_form() {
		if ( ! is_user_logged_in() ) {
			return '<div class="kcms-box kcms-notice">Please log in as a Teacher/Employee to submit a leave application. <a href="' . esc_url( wp_login_url( get_permalink() ) ) . '">Log in</a></div>';
		}
